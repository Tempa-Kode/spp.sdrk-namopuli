...
@section("page", "Tambah Tarif SPP")
@section("body")
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                <h6 class="mb-0">Tambah Data Tarif SPP</h6>
            ...
            <div class="card-body">
                ...
                <form action="{{ route("tarif-spp.store") }}" method="POST">
                    ...
                    <div class="alert alert-info text-white">
                        ...
                        <strong>Catatan:</strong> Pastikan kombinasi tahun dan tingkat kelas belum ada dalam sistem.
                    </div>
