...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('landing/img/logo.svg') }}">
    <title>
        Login
    </title>
    <!--     Fonts and icons     -->
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                        <div class="card card-plain mt-8">
                            <div class="card-header pb-0 text-left bg-transparent">
                                <h3 class="font-weight-bolder text-info text-gradient">Login akun anda</h3>
                                <p class="mb-0">Masukkan kredensial anda untuk login</p>
                            </div>
